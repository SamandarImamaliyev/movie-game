...
const movies = ["atlanta", "Breaking bad", "friends", "Game of Thrones", "gibi", "Severance", "Sherlock", "succession", "The big bang theory"];
let predictedLetter = "";
...
function setImage(randomMovie) {
    image.src = `../image/TV series/${randomMovie}.jpg`;
}
